...
//     }
//     setFilteredProducts(filtered);
//   }, [priceRange, selectedColor, selectedCategory, products]);
...
//           <aside className="w-full lg:w-1/4 gap-2 bg-white p-4 rounded-lg shadow-md mb-8 lg:mb-0">
//             <h2 className="text-xl font-semibold mb-4 border-b flex justify-between pb-5">
//               Filters <Image src={vector} alt="vector" />
//             </h2>
//             <div className="border-b pb-4">
//               {categories.map(category => (
//                 <p key={category} className="flex mb-2 cursor-pointer" onClick={() => setSelectedCategory(category)}>
...
//             <div className="mb-4">
//               <h3 className="text-lg font-bold mb-2">Price</h3>
//               <input type="range" min="50" max="500" value={priceRange} onChange={e => setPriceRange(Number(e.target.value))} className="w-full" />
//             </div>
//             <div className="mb-4">
//               <h3 className="text-lg font-bold mb-2">Colors</h3>
//               <div className="flex flex-wrap gap-2">
//                 {colors.map(color => (
//                   <div key={color} className={`w-6 h-6 rounded-full cursor-pointer border ${selectedColor === color ? "border-black" : "border-gray-300"}`} style={{ backgroundColor: color }} onClick={() => setSelectedColor(color)} />
//                 ))}
//               </div>
//             </div>
//           </aside>
...
//                         <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
//                           <button className="bg-black text-white px-14 py-5 rounded-lg flex items-center justify-center text-lg font-semibold relative overflow-hidden group/button">
//                             <span className="absolute transition-all duration-300 transform group-hover/button:translate-y-full">Add to Cart</span>
//                             <IoCart className="absolute transition-all duration-300 transform translate-y-full group-hover/button:translate-y-0 w-6 h-6" />
//                           </button>
//                         </div>
//                       </div>
...
//                       </div>
//                       <div className="flex justify-center items-center gap-2">
//                         <p className="text-lg font-bold text-black">${item.price - ((item.discountPercent || 0) / 100) * item.price}</p>
//                         {item.discountPercent && <><p className="line-through text-gray-400">${item.price}</p><p className="text-red-600">-{item.discountPercent}%</p></>}
//                       </div>
//                     </div>
//                   </Link>
//                 </div>
...
// function includes(selectedColor: string) {
...
const CasualPage = () => {
  ...
  const colors = ["red", "green", "blue", "yellow", "orange", "pink", "black", "white"];
  const sizes = ["XX-Small", "X-Small", "Small", "Medium", "Large", "X-Large", "XX-Large", "3X-Large", "4X-Large"];
  const styles = ["Casual", "Formal", "Party", "Gym"];
  const categories = ["T-shirt", "Shorts", "Shirts", "Hoodies", "Jeans"];
