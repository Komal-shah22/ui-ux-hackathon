...
const CasualPage = () => {
  ...
  useEffect(()=>{
    let filtered = products.filter(products =>products.price <= priceRange);
    if (selectedColor) {
  ...
  },[priceRange,selectedColor,products]);
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="container mx-auto px-4 py-8 mb-10 mt-8">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <p className="font-extrabold text-4xl text-center text-black col-span-full">
                Product Not Found
              </p>
            )}
            </div>
