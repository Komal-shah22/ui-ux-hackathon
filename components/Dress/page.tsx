  ...
  return (
    <div className="w-full max-w-[1239px] mx-auto h-auto mt-10 pb-10 rounded-xl bg-[#F0F0F0]">
      ...
      <div className="flex flex-wrap justify-center mt-10 gap-4 px-4">
        <div className="relative w-full sm:w-[407px] lg:w-[407px] h-[200px] sm:h-[250px] md:h-[289px] rounded-3xl overflow-hidden">
          <Image
            src={cofounder2}
            alt="cofounder"
        ...
        <div className="relative w-full sm:w-[684px] lg:w-[684px] h-[200px] sm:h-[250px] md:h-[289px] rounded-3xl overflow-hidden">
          <Image
            src={cofounder}
            alt="cofounder"
            className="w-full h-full object-cover"
