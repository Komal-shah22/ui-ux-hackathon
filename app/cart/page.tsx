...
// const CartPage = () => {
//   const [cartItems, setCartItems] = useState<Product[]>(getCartItem());
//   const router = useRouter(); 

//   useEffect(() => {
//     if (typeof window !== "undefined") { // ✅ Ensure client-side rendering
...
//               ...item,
//               inventory:
//                 type === "increment" ? item.inventory + 1 : Math.max(item.inventory - 1, 1),
//             }
//           : item
//       )
//     );
//     updateCartQuantity(id, type === "increment" ? 1 : -1);
//   };
...
//   return (
//     <AuthGuard>
//       <div className="min-h-screen pb-10 py-10 bg-gray-100">
...
//                 </div>
//                 <button onClick={handleProceed} className="w-full bg-black text-white py-3 mt-6 rounded-lg text-lg font-semibold hover:bg-gray-800 transition">
//                   Go to Checkout →
//                 </button>
//               </div>
//             </div>
...
const CartPage = () => {
  ...
  if (!cartItems) return null; // Avoid errors in SSR
